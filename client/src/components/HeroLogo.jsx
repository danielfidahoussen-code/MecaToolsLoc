...
export default function HeroLogo() {
  ...
  useEffect(() => {
    const onScroll = () => {
      ...
      // progress 0 = assembled, 1 = fully disassembled
      const p = Math.min(1, Math.max(0, -rect.top / (heroH * 0.7)));
      setProgress(p);
    };
  ...
  // Each part gets its own disassemble vector
  ...
  return (
    <div ref={heroRef} style={{ position: 'relative', width: '100%', display: 'flex', justifyContent: 'center', padding: '10px 0 20px' }}>
      <svg width="320" height="280" viewBox="0 0 320 280" fill="none" xmlns="http://www.w3.org/2000/svg"
        style={{ filter: 'drop-shadow(0 0 30px rgba(255,32,32,0.3))' }}>
