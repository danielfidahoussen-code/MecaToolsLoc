...
export function CartProvider({ children }) {
  ...
  const addItem = (product, type, quantity = 1, rentDates = null) => {
    setItems(prev => {
      ...
      return [...prev, { key, id: product.id, name: product.name, image: product.image, type, quantity, price, rentDates, has_qr_notice: !!product.has_qr_notice, caution: type === 'rent' ? (product.caution || 0) : 0 }];
    });
    setIsOpen(true);
  };
