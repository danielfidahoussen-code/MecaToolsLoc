    ...
    <div>
      ...
      <div className="page">
        <div className="container" style={{ maxWidth: 800 }}>
          ...
          <LegalSection title="14. Contrats et franchises">
            <p>Le texte intégral des contrats de location (outillage et véhicule) ainsi que le barème des franchises applicables aux locations de véhicules sont publiés, à titre informatif, sur la page <Link to="/contrats-et-franchises" style={{ color: 'var(--accent)', fontWeight: 600 }}>Contrats & Franchises</Link> du site. Le document qui fait foi reste, dans tous les cas, le contrat papier signé par le Client sur place lors de la remise du matériel ou du véhicule.</p>
          </LegalSection>
